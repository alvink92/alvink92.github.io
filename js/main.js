...
$(function() {
  ...
  jQuery(document).ready(
    (function($) {
      ...
      // $(function() {
      //   element.typed({
      //     strings: ["Software Developer", "Gamer", "Your Best Friend"],
      //     typeSpeed: 100,
      //     loop: true
      //   });
      // });
      ...
      function onScroll(event) {
        ...
        $(".navbar-nav a").each(function() {
          ...
          if (
            ...
            refElement.position().top - 84 + refElement.height() > scrollPos
          ) {
      ...
      //Smooth Scroll
      $(".nav a,#home a,#about a,#quote a,[href='#body']").on("click", function(
        event
      ) {
        if (this.hash !== "") {
